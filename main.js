...
//role_has_permissions
 `CREATE TABLE IF NOT EXISTS "role_has_permissions" (
  ...
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  "razorpay_type" TEXT  DEFAULT 'test' ,
  ...
  "razorpay_status" TEXT  DEFAULT '0' ,
  "stripe_type" TEXT  DEFAULT 'test' ,
  ...
  "stripe_status" TEXT DEFAULT '0' ,
  "created_at" TEXT   ,
  "updated_at" TEXT   ,
  "flutterwave_status" TEXT DEFAULT '0' ,
  "flutterwave_type" TEXT DEFAULT 'test' ,
  "test_flutterwave_key" TEXT   ,
  "test_flutterwave_secret" TEXT   ,
  "test_flutterwave_hash" TEXT   ,
  ...
  "test_paystack_merchant_email" TEXT   ,
  "paystack_payment_url" TEXT  DEFAULT 'https://api.paystack.co' ,
  "paystack_status" TEXT  DEFAULT '0' ,
  "paystack_mode" TEXT  DEFAULT 'sandbox' ,
  "newfield1" TEXT,
  "newfield2" TEXT,
  "newfield3" TEXT,
  "isSync" BOOLEAN DEFAULT 0
